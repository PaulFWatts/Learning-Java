...
public class Product {
  ...
  public Product(String sku, String code, String description, Double costPrice, Double sellPrice, Size productSize,
      Size packSize, Double maxDiscountPercent, Double minMarkupPercent) {
    this.sku = sku;
    this.code = code;
  ...
  public String toString() {
    String output = (sku + " " + code + " " + description + " $" + costPrice + " $" + sellPrice + " " + productSize
        + " " + packSize + " " + maxDiscountPercent + "% " + minMarkupPercent + "%");
    return output;
  }
}
