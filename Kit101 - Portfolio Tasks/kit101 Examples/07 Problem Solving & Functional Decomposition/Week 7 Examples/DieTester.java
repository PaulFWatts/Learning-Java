...
public class DieTester {
    ...
    public static void main(String[] args) {
        ...
        d1 = new Die();
        //The following will not compile because numFaces is (quite rightly) private in Die
        //System.out.println("Number of faces on d1 is " + d1.numFaces);
        d2 = new Die(8);
        d3 = new Die(2);
